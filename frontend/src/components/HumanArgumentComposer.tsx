...
export default function HumanArgumentComposer({ debateId }: HumanArgumentComposerProps) {
    ...
    <section className="rounded-lg border border-arena-line bg-arena-panel/88 p-4 shadow-glow">
      <div className="mb-3 flex items-center justify-between gap-3">
        <h2 className="flex items-center gap-2 text-sm font-semibold text-arena-text">
          ...
          Your turn - write the next PRO argument
        </h2>
      ...
      <textarea
        ...
        placeholder="Make a clear claim, answer the opponent, and support it with evidence..."
